...
class BK_HousingDecision:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                "初始资金池": ("INT", {"default": 1000000, "min": 0}),
                "房价": ("INT", {"default": 2500000, "min": 0}),
                "首付比例": ("FLOAT", {"default": 0.3, "min": 0, "max": 1, "step": 0.01, "display": "slider"}),
                "交房等待月份": ("INT", {"default": 24, "min": 0}),
                "房贷年限": ("INT", {"default": 20, "min": 0}),
                "公积金贷款额度": ("INT", {"default": 600000, "min": 0}),
                ...
                "月开销": ("INT", {"default": 5000, "min": 0}),
                "租房费用": ("INT", {"default": 5000, "min": 0}),
                "月收入": ("INT", {"default": 15000, "min": 0}),
                "工资年涨幅": ("FLOAT", {"default": 0.05, "min": 0, "max": 1, "step": 0.01}),
                "公积金": ("INT", {"default": 5000, "min": 0}),
                "年终奖": ("INT", {"default": 50000, "min": 0}),
                "剩余工作年限": ("INT", {"default": 3, "min": 0}),
